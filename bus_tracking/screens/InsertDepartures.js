...
export default function InsertDeparturesScreen() {
  ...
  return (
    <View style={styles.main_container}>
      <View style={styles.header}>
        <Text style={styles.header_text}>INSERT DEPARTURES</Text>
      </View>
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            // Combine date and time into dateTimeDepart
            ...
            addDoc(collection(firestoreDB, "bus_departures"), {
              departTo: departTo,
              plateNo: plateNumber,
